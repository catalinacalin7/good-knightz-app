    ...
    332: () => {
      ...
      function a0() {
        return (function oi(e, t) {
          return 4 & e.type ? new s0(t, e, Tn(e, t)) : null;
        })(he(), y());
      }
      let Dt = (() => {
        class e {}
      ...
      class Ce {
        ...
        runTask(t, n, r, o) {
          const i = this._inner,
            s = i.scheduleEventTask("NgZoneEvent: " + o, t, K0, si, si);
          try {
        ...
        _mismatch(t, n, r, o) {
          ...
          return (
            ...
            (t =
              ...
              : (t = this._addAfter(new yb(n, r), i, o)),
            t
          );
        }
      ...
      class lg {
        ...
        put(t) {
          ...
          r || ((r = new Db()), this.map.set(n, r)), r.add(t);
        }
        get(t, n) {
      ...
      class Ou extends class pM extends class Sb {} {
        constructor() {
      ...
      let LM = (() => {
        ...
        return (
          ...
          (e.ɵmod = tr({ type: e })),
          (e.ɵinj = un({ providers: [...Zg, ...Qg], imports: [zI, bb] })),
          e
        );
      })();
      typeof window < "u" && window;
        ...
        WM = (() => {
          ...
          return (
            ...
            (e.ɵcmp = Xe({
              ...
              decls: 4,
              vars: 0,
              consts: [["src", "assets/icon1.svg", 1, "icon1"]],
              template: function(n, r) {
                1 & n &&
                  (L(0, "button"),
                  se(1, "img", 0),
              ...
              styles: [
                "button[_ngcontent-%COMP%]{background-color:#9948e6;color:#fff;width:85%;font-size:4.7vw;border:none;border-radius:25px;margin:auto;display:flex;align-items:center;justify-content:center;padding:3% 0;font-family:MontserratRegular}span[_ngcontent-%COMP%]{padding-left:7%}.icon1[_ngcontent-%COMP%]{width:12%}"
              ]
            })),
            e
          );
          ...
          return (
            ...
            (e.ɵcmp = Xe({
              ...
              consts: [
                [1, "faq-wrapper"],
                [1, "txt-center"],
                ["src", "assets/birdonrock.svg", 1, "bird-img"],
                [1, "questions-wrapper"],
                [
                  "class",
        ...
        KM = (() => {
          ...
          return (
            ...
            (e.ɵcmp = Xe({
              ...
              styles: [
                "button[_ngcontent-%COMP%]{color:#321a70;border-radius:5px;padding:5%;border:3px solid #321A70;width:100%;background-color:transparent;font-family:MontserratSemiBold}button[_ngcontent-%COMP%]   img[_ngcontent-%COMP%]{width:4%}button[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{font-size:4.7vw;padding-right:5%}"
              ]
            })),
            e
          );
          ...
          return (
            ...
            (e.ɵcmp = Xe({
              ...
              consts: [
                ...
                ["src", "assets/knighticon.svg", 1, "logo-img"],
                [1, "solid"],
                [1, "rarefied"],
                [1, "footer-item"]
              ],
